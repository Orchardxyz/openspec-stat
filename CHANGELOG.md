...
- b630198: Migrate to ESM-only build and fix module resolution errors.
...
- c02e8e5: Improve CLI feedback by switching to the new spinner manager, reducing emoji usage, and fixing remote clone progress reporting.
- cbf5199: Remove .js file extensions from all TypeScript imports and add ESLint rule to prevent future occurrences.
